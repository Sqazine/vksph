...
VulkanInstance::VulkanInstance(SDL_Window *window, const std::vector<const char *> &neededValidationLayers)
...
const VkSurfaceKHR &VulkanInstance::GetVKSurfaceKHRHandle() const
{
    return m_SurfaceHandle;
}

const std::vector<const char *>& VulkanInstance::GetNeededValidationLayers() const
{
    return m_NeededValidationLayers;
}

void VulkanInstance::CreateDebugUtilsMessenger()
{
#if _DEBUG
